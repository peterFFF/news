...
<div class="section clear">
	<div class="side-left-680">
		<?php if($fetchImg3 != NULL): ?><div id="focus-wrapper2">
			<ul id="focus-image">
			<?php if(is_array($fetchImg3)): foreach($fetchImg3 as $key=>$v): ?><li><a href="/NewsViewTP/index.php/Articles/index/articleId/<?php echo ($v['articleId']); ?>" target="_blank" ><img src="/NewsViewTP/public/<?php echo ($v["imagepath"]); ?>"  style="width:680px;height:320px;"/></a></li><?php endforeach; endif; ?>	
			</ul>
			<div id="focus-mask"></div>
			<ul id="focus-text">
			<?php if(is_array($fetchImg3)): foreach($fetchImg3 as $key=>$v): ?><li><a href="/NewsViewTP/index.php/Articles/index/articleId/<?php echo ($v['articleId']); ?>" target="_blank" ><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; ?>	
			</ul>
	...
	<script>
		...
		<div>
			<?php if(is_array($fetchtype)): foreach($fetchtype as $key=>$v): ?><div class="news-list-item clear">
				<?php if($v['imagepath'] != ''): ?><div class="news-list-item-pic"><a href="/NewsViewTP/index.php/Articles/index/articleId/<?php echo ($v['articleId']); ?>"><img src="/NewsViewTP/public/<?php echo ($v['imagepath']); ?>" width="200" alt=""/></a></div>
				<?php else: ?>
				<div class="news-list-item-pic"><a href="/NewsViewTP/index.php/Articles/index/articleId/<?php echo ($v['articleId']); ?>"><img src="/NewsViewTP/public/photoview/logo.png" width="200" alt=""/></a></div><?php endif; ?>
				<div class="news-list-item-txt">
					<h1><a href="/NewsViewTP/index.php/Articles/index/articleId/<?php echo ($v['articleId']); ?>"><span class="keytitle"><?php echo ($v["title"]); ?></span></a></h1>
					<?php if($keyword != NULL): ?><script src="/NewsViewTP/library/jquery/jquery-1.10.0.js"></script>
					<script>
						...
						$(function(){
							//echo $keyword=<?php echo ($keyword); ?>;
							toRed('<?php echo ($keyword); ?>');
						});
					</script><?php endif; ?>
					<p><?php echo (strip_tags(truncate($v['content'],100))); ?></p>
				</div>
