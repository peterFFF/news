...
<div id="header-wrapper">
	<div class="wrapper">
		<div id="header">
			...
			<div class="side-right login-bar"><a href="/NewsViewTP/index.php/Register/index" >免费注册</a><a href="/NewsViewTP/index.php" >返回首页</a></div>
		</div>
	</div>
</div>
<div id="login-wrapper">
	<div id="login-main">
		<form action="/NewsViewTP/index.php/Login/login" method="post" id="login-form">
